...
def prepare_text(text):
    ...
    text_without_punctuation = text_lower_case.replace("?", "").replace("!", "").replace(",", "").replace("\"", "").replace(".", "")
...
def percent_difference(value1, value2):
    perc_difference = abs(value1 - value2) / ((value1 + value2) / 2)
...
print(lily_sample.author + "'s intro note's similarity score to the murder letter is: " + str(find_text_similarity(murderer_sample, lily_sample)))
print(myrtle_sample.author + "'s intro note's similarity score to the murder letter is: " + str(find_text_similarity(murderer_sample, myrtle_sample)))
print(gregg_sample.author + "'s intro note's similarity score to the murder letter is: " + str(find_text_similarity(murderer_sample, gregg_sample)))
